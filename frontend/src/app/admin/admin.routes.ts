    ...
    children: [
      {
        path: '',
        loadComponent: () =>
          import('./indexes/indexes.component').then((m) => m.IndexesComponent),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./components/mapping-values/mapping-values.component').then(
            (m) => m.MappingValuesComponent,
          ),
        canActivate: [AdminGuard],
        data: { parentRoute: 'indexes' },
      },
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./plugins/plugins.component').then((m) => m.PluginsComponent),
        canActivate: [AdminGuard],
        data: { parentRoute: 'indexes' },
      },
      {
        ...
        loadComponent: () =>
          import('./indexes-dashboard/indexes-dashboard.component').then(
            (m) => m.IndexesDashboardComponent,
          ),
        canActivate: [AdminGuard],
      },
      {
        ...
        loadComponent: () =>
          import('./appearance/appearance.component').then(
