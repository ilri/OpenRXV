...
*Note: Elasticsearch requires a username and password, to override this execute `docker exec elasticsearch bash -c 'cat /usr/share/elasticsearch/config/elasticsearch.yml' && docker restart elasticsearch`
